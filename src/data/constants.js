  ...
  },
  {
    ...
    skills: [
      ...
      },
      {
        name: "Postman",
        image:
          "https://www.svgrepo.com/download/354202/postman-icon.svg",
      },
      {
        name: "IntelliJ",
        image:
...
export const education = [
  {
    id: 0,
    img: "https://nbnstic.sinhgad.edu/wp-content/uploads/2022/07/Sinhgad-Institutes-custom-1536x1006.png",
    school: "Sinhgad Acadamy of Engineering, Pune",
  ...
  },
  {
    ...
    school: "G.H Raisoni polytechnic, Jalgaon",
  ...
  {
    id: 2,
    img: "https://images.vexels.com/media/users/3/224234/isolated/preview/ff7c525c1c3e1bef640644542001e1fd-online-school-logo.png",
    school: "Bhagirath English School, Jalgaon",
...
export const projects = [
  {
    id: 9,
    title: "Harley Devidson Clone Website",
    date: "Aug 2020 - Sep 2020",
    description:
      "It is Clone Website of Official Harley Devidson india website. For Frontend HTML,CSS,Bootstrap is Used and For Backend XAMPP,Laravel is Used.",
    image:
      "https://raw.githubusercontent.com/imvinay10/Harley-Davidson-Clone/main/Screenshot%20New.png",
    tags: [
      "PHP",
      "Laravel",
      "NodeJs",
    ...
    category: "web app",
    github: "https://github.com/imvinay10/Harley-Davidson-Clone",
  },
  {
    id: 0,
    ...
    description:
      "The project is android based to compress larger sized media like images and videos to small sized media by compromising minimum on the quality of media.",
    image:
      "https://raw.githubusercontent.com/imvinay10/MediaCompressor-master/4a2325b020d3be3a4f69da9b3153605c8f24f048/ScreenShots/Media%20Compressor%20SS.jpg?token=GHSAT0AAAAAACNFR43S5WDUJ667HRDTZ5KAZNOVVNA",
  ...
  {
    id: 1,
    title: "Web Mining to Detect online Spread to Terrorism",
    date: "Oct 2021 - March 2022",
    description:
      "Our System Detect Terrorist Patterns On Websites Using Textual data and Photos, Videos on site.We will use Graphical Processing Algorithms to Detect Terrorist Activities. The website should be flagged inappropriate if the keywords or Image are found for efficient system development",
    image:
      "https://raw.githubusercontent.com/imvinay10/Detection-Of-Online-Spread-of-Terrorism/main/Detect%20Online%20Spread%20Of%20Terrorsim/Research%20Paper/8.png",
    tags: [
      "React Js",
      "MongoDb",
      "Node Js",
